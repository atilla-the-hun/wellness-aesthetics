...
const TreatmentProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(TreatmentContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/treatment/update-profile', updateData, { headers: { dToken } })
